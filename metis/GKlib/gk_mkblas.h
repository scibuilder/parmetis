...
/*************************************************************************/\
METIS_EXPORT TYPE *PRFX ## incset(size_t n, TYPE baseval, TYPE *x)\
{\
  size_t i;\
\
  for (i=0; i<n; i++)\
...
/*************************************************************************/\
METIS_EXPORT TYPE PRFX ## max(size_t n, TYPE *x)\
{\
  size_t i, max=0; \
\
...
/*************************************************************************/\
METIS_EXPORT TYPE PRFX ## min(size_t n, TYPE *x)\
{\
  size_t i, min=0;\
\
  if (n <= 0) return (TYPE) 0;\
...
/*************************************************************************/\
METIS_EXPORT size_t PRFX ## argmax(size_t n, TYPE *x)\
{\
  size_t i, max=0;\
\
  for (i=1; i<n; i++)\
...
/*************************************************************************/\
METIS_EXPORT size_t PRFX ## argmin(size_t n, TYPE *x)\
{\
  size_t i, min=0;\
\
  for (i=1; i<n; i++)\
...
/*************************************************************************/\
METIS_EXPORT size_t PRFX ## argmax_n(size_t n, TYPE *x, size_t k)\
{\
  size_t i, max_n;\
  PRFX ## kv_t *cand;\
\
...
/**************************************************************************/\
METIS_EXPORT OUTTYPE PRFX ## sum(size_t n, TYPE *x, size_t incx)\
{\
  size_t i;\
  OUTTYPE sum = 0;\
\
...
/**************************************************************************/\
METIS_EXPORT TYPE *PRFX ## scale(size_t n, TYPE alpha, TYPE *x, size_t incx)\
{\
  size_t i;\
\
  for (i=0; i<n; i++, x+=incx)\
...
/**************************************************************************/\
METIS_EXPORT OUTTYPE PRFX ## norm2(size_t n, TYPE *x, size_t incx)\
{\
  size_t i;\
  OUTTYPE partial = 0;\
\
...
/**************************************************************************/\
METIS_EXPORT OUTTYPE \
PRFX ## dot(size_t n, TYPE *x, size_t incx, TYPE *y, size_t incy)\
{\
  size_t i;\
  OUTTYPE partial = 0.0;\
 \
...
/**************************************************************************/\
METIS_EXPORT TYPE *\
PRFX ## axpy(size_t n, TYPE alpha, TYPE *x, size_t incx, TYPE *y, size_t incy)\
{\
  size_t i;\
  TYPE *y_in = y;\
\
...
#define GK_MKBLAS_PROTO(PRFX, TYPE, OUTTYPE) \
  ...
  METIS_EXPORT TYPE    *PRFX ## scale(size_t n, TYPE alpha, TYPE *x, size_t incx);\
  METIS_EXPORT OUTTYPE  PRFX ## norm2(size_t n, TYPE *x, size_t incx);\
  METIS_EXPORT OUTTYPE  PRFX ## dot(size_t n, TYPE *x, size_t incx, TYPE *y, size_t incy);\
  METIS_EXPORT TYPE    *PRFX ## axpy(size_t n, TYPE alpha, TYPE *x, size_t incx, TYPE *y, size_t incy);
