...
/**************************************************************************/\
METIS_EXPORT PQT *FPRFX ## Create2(ssize_t maxnodes)\
{\
  PQT *queue; \
\
...
/**************************************************************************/\
METIS_EXPORT void FPRFX ## Reset2(PQT *queue)\
{\
  queue->nnodes = 0;\
}\
\
...
/**************************************************************************/\
METIS_EXPORT void FPRFX ## Destroy2(PQT **r_queue)\
{\
  PQT *queue = *r_queue; \
...
/**************************************************************************/\
METIS_EXPORT size_t FPRFX ## Length2(PQT *queue)\
{\
  return queue->nnodes;\
}\
\
...
/**************************************************************************/\
METIS_EXPORT int FPRFX ## Insert2(PQT *queue, VT val, KT key)\
{\
  ssize_t i, j;\
  KT *keys=queue->keys;\
  VT *vals=queue->vals;\
...
/**************************************************************************/\
METIS_EXPORT int FPRFX ## GetTop2(PQT *queue, VT *r_val)\
{\
  ssize_t i, j;\
...
/**************************************************************************/\
METIS_EXPORT int FPRFX ## SeeTopVal2(PQT *queue, VT *r_val)\
{\
  if (queue->nnodes == 0) \
    return 0;\
\
...
/*! This function returns the key of the top item. The item is not\
    deleted from the queue. */\
/**************************************************************************/\
METIS_EXPORT KT FPRFX ## SeeTopKey2(PQT *queue)\
{\
...
/**************************************************************************/\
METIS_EXPORT int FPRFX ## CheckHeap2(PQT *queue)\
{\
  ssize_t i;\
  KT *keys=queue->keys;\
\
...
#define GK_MKPQUEUE2_PROTO(FPRFX, PQT, KT, VT)\
  ...
  METIS_EXPORT void   FPRFX ## Destroy2(PQT **r_queue);\
  METIS_EXPORT size_t FPRFX ## Length2(PQT *queue);\
  METIS_EXPORT int    FPRFX ## Insert2(PQT *queue, VT node, KT key);\
  METIS_EXPORT int    FPRFX ## GetTop2(PQT *queue, VT *r_val);\
  METIS_EXPORT int    FPRFX ## SeeTopVal2(PQT *queue, VT *r_val);\
  METIS_EXPORT KT     FPRFX ## SeeTopKey2(PQT *queue);\
  METIS_EXPORT int    FPRFX ## CheckHeap2(PQT *queue);
